...
class S3Bucket():
    ...
    ##method launched from donwload_tool, options are always incluided
    def update_params_from_dict(self,options_dict):
        self.PRODUCT = options_dict['product']
        self.DATASET = options_dict['dataset']
        self.S3_ENDPOINT = options_dict['endpoint']
